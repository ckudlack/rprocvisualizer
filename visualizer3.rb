...
def setup
    ...
    size(900,600)  # let's pick a more interesting size
  ...
  def setup_sound
    ...
    @levelnx = Array.new(10)
    @levelpx = Array.new(10)
    @levelny = Array.new(10)
    @levelpy = Array.new(10)
...
def animate_sound
  ...
  #Center Circle w/ low freq size
  @size = @scaled_ffts[0]*height/4
  ...
  #outward radiating rectangles (array locations 1-9)
